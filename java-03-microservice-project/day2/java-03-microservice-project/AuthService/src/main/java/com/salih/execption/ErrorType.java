...
public enum ErrorType {
    ...
    REGISTER_USERNAME_EXISTS (1005, "Bu kullanici adi sistemde alinmiştir.", HttpStatus.BAD_REQUEST),

    DOLOGIN_USERNAME_OR_PASSWORD_MISMATCH  (3001, "Kullanıcı veya parola adi hatalı.", HttpStatus.BAD_REQUEST),
